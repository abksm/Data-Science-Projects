...
def check_null_or_valid(row_data):
    """Fonction qui prend une ligne de données,
    supprime toutes les valeurs manquantes
     et vérifie si toutes les valeurs restantes sont supérieures ou égales à 0
    """
